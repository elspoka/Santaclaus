	...
	return Controller.extend("sap.ui.santaclaus.controller.restocking", {
		...
		onInit : function () {
	        var oModel = new sap.ui.model.json.JSONModel();        
	         ...
	         $.ajax({
	     		dataType: "json",
	     		url: "https://raw.githubusercontent.com/elspoka/Santaclaus/master/mockup_api/Suppliers.json",
	     		type: "GET",
		...
		//	sap.m.MessageToast.show("This message should appear in the message toast");
			...
			oRouter.navTo("supplierdetails", {
				supplierPath: oItem.getBindingContext("suppliers").getPath().substr(1).replace("/","")
